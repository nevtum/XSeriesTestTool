...
#
# Created: Sat Sep 08 13:21:12 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.btnRecordPause, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnRefresh, 1, 7, 1, 1)
        self.btnClear = QtGui.QPushButton(self.centralwidget)
        self.btnClear.setObjectName(_fromUtf8("btnClear"))
        self.gridLayout.addWidget(self.btnClear, 1, 8, 1, 1)
        self.cbFilterDupes = QtGui.QCheckBox(self.centralwidget)
        self.cbFilterDupes.setEnabled(True)
        self.cbFilterDupes.setObjectName(_fromUtf8("cbFilterDupes"))
        self.gridLayout.addWidget(self.cbFilterDupes, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnAnalyze, 2, 8, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtGui.QApplication.translate("MainWindow", "XSeriesTestTool", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MainWindow", "Regex Filter:", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("MainWindow", "Replay Recording", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cbFilterDupes.setText(QtGui.QApplication.translate("MainWindow", "Ignore Dupes", None, QtGui.QApplication.UnicodeUTF8))
